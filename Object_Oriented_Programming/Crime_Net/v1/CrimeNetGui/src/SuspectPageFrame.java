...
public class SuspectPageFrame {
	...
	JTextArea numbersInUseArea = new JTextArea(4,10);
	
	// Second section
	JPanel smsPanel = new JPanel();
	JTextField phoneNumber = new JTextField();
	JTextArea smsTextArea = new JTextArea(10,20);
	JButton findSMSButton = new JButton("Find SMS");
	
	// Third section
	JPanel partnersPanel = new JPanel();
	JLabel partnersLabel = new JLabel("Partners");
	JTextArea partnersTextArea = new JTextArea(10,20);
	
	// Forth section
	JPanel suggestedPartnersPanel = new JPanel();
	JLabel suggestedPartnersLabel = new JLabel("Suggested Partners");
	JTextArea suggestedPartnersTextArea = new JTextArea(5,20);
	
	// Back to search button
	JButton backToScreenButton = new JButton("Back To Search Screen");
	...
	public SuspectPageFrame(Suspect suspect, Registry aRegistry) {
		...
		phoneNumber.setText("Enter Number");
